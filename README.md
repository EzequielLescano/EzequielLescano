<h1 align="center">Hi , I'm Ricardo Ezequiel Lescano <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>

## <picture><img src = "https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/about_me.gif?raw=true" width = 50px></picture> About me
<picture> <img align="right" src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Right_Side.gif?raw=true" width = 250px></picture>
<br>

- :school: I am a `second-year Information Systems` student at [Facultad de Ciencia y Tecnología](https://fcytcdelu.uader.edu.ar).
- :technologist: I love using Software as a solution for every `problem`.
- :computer: I am certified in `Java`, `Python`, and data visualization with `Power BI`.
